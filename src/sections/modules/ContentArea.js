    ...
    render() {
        ...
        return (
            <div className='contentArea'>
                ...
                {(section.button) ? <div className='button-wrapper'><Link target={(section.button.target) ? "_blank" : ""} className="halcyon-button"  to={helpers.convertLink(section.button.url, this.props.title.toLowerCase())}>{ReactHtmlParser(section.button.title)}</Link></div> : ""} 
                </div>: ""}
                ...
                <Row>
                    ...
                    {(section.button_2) ? <div className='button-wrapper'><Link target={(section.button_2.target) ? "_blank" : ""} className="halcyon-button" to={helpers.convertLink(section.button_2.url, this.props.title.toLowerCase())}>{ReactHtmlParser(section.button_2.title)}</Link></div> : ""}
                    </Col>
                </Row>
                : ""}
               ...
               <Row>
                ...
                <Row>
                    ...
                    {(section.button_3) ? <div className='button-wrapper'><Link target={(section.button_3.target) ? "_blank" : ""} className="halcyon-button" to={helpers.convertLink(section.button_3.url, this.props.title.toLowerCase())}>{ReactHtmlParser(section.button_3.title)}</Link></div> : ""}
                    </Col>
                </Row>
                : ""}
                ...
                <Row>
                    ...
                    {(section.button_4) ? <div className='button-wrapper'><Link target={(section.button_4.target) ? "_blank" : ""} className="halcyon-button" to={helpers.convertLink(section.button_4.url, this.props.title.toLowerCase())}>{ReactHtmlParser(section.button_4.title)}</Link></div> : ""}
                    </Col>
                </Row>
                : ""}
            </div>    
