    ...
    render() {
        ...
        return (
            <div className='diningDirectory'>
                ...
                <input className='search-bar' type="submit" id="search-sales" title="search sales" placeholder="Search..." value={this.state.search} onChange={event => this.handleSearch(event.target.value)} />
                </div>
                </Container>
