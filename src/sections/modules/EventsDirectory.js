                ...
                <div className='heading-container'>
                    <Container>
                        ...
                        <div className="controls-container">
                            ...
                            <input className='search-bar' title="search events" type="submit" id="sTarget" placeholder="Search..." value={this.state.search} onChange={event => this.handleSearch(event.target.value)} />                         
                            </div>
