    ...
    render() {
        ...
        return (
            <div id="mobileFloatingNav">
                <a href={options.acf.google_map_directions_url}><img src={LocationIcon} /></a>
                <a href={'mailto:' + options.acf.email}><img src={EmailIcon} /></a>
                <a href={'tel:' + options.acf.phone}><img src={PhoneIcon} /></a>
            </div>
        )  
    }
})